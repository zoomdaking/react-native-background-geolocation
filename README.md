# @thekingzoom/react-native-background-geolocation
...
```
yarn add @thekingzoom/react-native-background-geolocation
```
...
```
node ./node_modules/@thekingzoom/react-native-background-geolocation/scripts/postlink.js
```
...
```gradle
...
include ':@thekingzoom_react-native-background-geolocation-common'
project(':@thekingzoom_react-native-background-geolocation-common').projectDir = new File(rootProject.projectDir, '../node_modules/@thekingzoom/react-native-background-geolocation/android/common')
include ':@thekingzoom_react-native-background-geolocation'
project(':@thekingzoom_react-native-background-geolocation').projectDir = new File(rootProject.projectDir, '../node_modules/@thekingzoom/react-native-background-geolocation/android/lib')
...
```
...
dependencies {
    ...
    compile project(':@thekingzoom_react-native-background-geolocation')
    ...
}
```
...
2. Add `./node_modules/@thekingzoom/react-native-background-geolocation/ios/RCTBackgroundGeolocation.xcodeproj`
...
import BackgroundGeolocation from '@thekingzoom/react-native-background-geolocation';
